...
define(["animate","jquery", "jquery-cookie"], function (animate,$) {
        ...
        $.ajax({
            ...
            success: function (arr) {
                for (var i = 0; i < arr.length; i++) {
                    ...
                    </a>`).appendTo(".swiper-container .swiper-wrapper");
                    //加小圆点的
    ...
    function containertab() {
        ...
        $('.swiper-buttonnext1 .iconfont,.swiper-buttonprev1 .iconfont').on("click", function () {
             ...
             if(num <=0){
                num=0;
                $(".swiper-buttonnext1 span,.swiper-buttonprev1 span").css('color','gray');
                ...
                $(".p-trap-wrap .swiper-wrapper").css('left',-num*271)
                $(".swiper-buttonnext1 span,.swiper-buttonprev1 span").css('color','white')
